...
def build_parser() -> argparse.ArgumentParser:
    ...
    report_group = parser.add_subparsers(dest="report_group", required=True)
    report = report_group.add_parser("report")
    simple_group = report.add_subparsers(dest="simple_group", required=True)
    simple = simple_group.add_parser("simple")
    context_group = simple.add_subparsers(dest="context_group", required=True)
